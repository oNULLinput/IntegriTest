...
beforeEach(() => {
  ...
  // Load fresh DOM from index.html
  ...
  // Setup window.location AFTER jsdom window ready
...
describe('Index.html - DOM Structure Tests', () => {
  test('should have correct page title and meta information', () => {
    ...
    expect(metaDescription.getAttribute('content')).toBe(
      'Empowering educational institutions with trustworthy online assessments'
    );
  ...
  test('should have exam reminder section with warning icon', () => {
...
describe('Index.html - Content Validation Tests', () => {
  ...
  test('should have proper section headers', () => {
    ...
    expect(sectionDescription.textContent).toBe(
      'Your data is secure with state-of-the-art encryption and privacy measures'
    );
  });
